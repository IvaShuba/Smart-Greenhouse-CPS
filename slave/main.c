...
#define CMD_GET_STATE		    0x40	// get all sensor data
...
typedef struct {
    ...
    uint8_t checksum;
	//uint8_t temp_level;        //not in use for slave node
	//uint8_t hum_level;         //not in use for slave node
	//uint8_t soil_level;        //not in use for slave node
	//uint8_t fan_status;        //not in use for slave node
	//uint8_t pump_status;       //not in use for slave node
	//uint8_t lcd_status;        //not in use for slave node
} SensorData;
